document.addEventListener("DOMContentLoaded", function () {
  ...
  const paragraphs = [
    ...
    "The train crept along gently, amid ash trees. It slowed down and stopped, almost in the middle of a field. No one called the name of a station. \"<em>Ashgrove?</em>\" I asked some children on the platform. \"<em>Ashgrove,</em>\" they replied. I got out.",
    "A lamp lit the platform, but the children's faces remained in a shadow. One of them asked me: \"<em>Are you going to Dr. Stephen Albert's house?</em>\" Without waiting for my answer, another said: \"<em>The house is a good distance away but you won't get lost if you take the road to the left and bear to the left at every crossroad./<em>\" I threw them a coin (my last), went down some stone steps and started along a deserted road. At a slight incline, the road ran downhill. It was a plain dirt way, and overhead the branches of trees intermingled, while a round moon hung low in the sky as if to keep me company.",
    ...
    "\"<em>I see that the worthy Hsi P'eng has troubled himself to see to relieving my solitude. No doubt you want to see the garden?</em>\"",
    "Recognizing the name of one of our consuls, I replied, somewhat taken aback.",
    "\"<em>The garden?</em>\"",
    "\"<em>The garden of forking paths.</em>\"",
    "Something stirred in my memory and I said, with incomprehensible assurance:",
    "\"<em>The garden of my ancestor, Ts'ui Pen.</em>\"",
    "\"<em>Your ancestor? Your illustrious ancestor? Come in.</em>\"",
    ...
    "\"<em>A strange destiny,</em>\" said Stephen Albert, \"<em>that of Ts'ui Pen - Governor of his native province, learned in astronomy, in astrology and tireless in the interpretation of the canonical books, a chess player, a famous poet and a calligrapher. Yet he abandoned all to make a book and a labyrinth. He gave up all the pleasures of oppression, justice, of a well-stocked bed, of banquets, and even of erudition, and shut himself up in the Pavilion of the Limpid Sun for thirteen years. At his death, his heirs found only a mess of manuscripts. The family, as you doubtless know, wished to consign them to the fire, but the executor of the estate - a Taoist or a Buddhist monk - insisted on their publication.</em>\"",
    "\"<em>Those of the blood of Ts'ui Pen,</em>\" I replied, \"<em>still curse the memory of that monk. Such a publication was madness. The book is a shapeless mass of contradictory rough drafts. I examined it once upon a time: the hero dies in the third chapter, while in the fourth he is alive. As for that other enterprise of Ts'ui Pen ... his Labyrinth...</em>\"",
    "\"<em>Here is the Labyrinth,</em>\" Albert said, pointing to a tall, laquered writing cabinet.",
    "\"<em>An ivory labyrinth?</em>\" I exclaimed. \"<em>A tiny labyrinth indeed...!</em>\"",
    "\"<em>A symbolic labyrinth,</em>\" he corrected me. \"<em>An invisible labyrinth of time. I, a barbarous Englishman, have been given the key to this transparent mystery. After more than a hundred years most of the details are irrecoverable, lost beyond all recall, but it isn't hard to image what must have happened. At one time, Ts'ui Pen must have said; 'I am going into seclusion to write a book,' and at another, 'I am retiring to construct a maze.' Everyone assumed these were separate activities. No one realized that the book and the labyrinth were one and the same. The Pavilion of the Limpid Sun was set in the middle of an intricate garden. This may have suggested the idea of a physical maze.</em>",
    "\"<em>Ts'ui Pen died. In all the vast lands which once belonged to your family, no one could find the labyrinth. The novel's confusion suggested that it was the labyrinth.",
    "Two circumstances showed me the direct solution to the problem. First, the curious legend that Ts'ui Pen had proposed to create an infinite maze, second, a fragment of a letter which I discovered.</em>\"",
    "Albert rose. For a few moments he turned his back to me. He opened the top drawer in the high black and gilded writing cabinet. He returned holding in his hand a piece of paper which had once been crimson but which had faded with the passage of time: it was rose colored, tenuous, quadrangular. Ts'ui Pen's calligraphy was justly famous. Eagerly, but without understanding, I read the words which a man of my own blood had written with a small brush: \"<em>I leave to various future times, but not to all, my garden of forking paths.</em>\"",
    ...
    "\"<em>If you will put up with my atrocious pronunciation, I would like to read you a few pages of your ancestor's work.</em>\"",
